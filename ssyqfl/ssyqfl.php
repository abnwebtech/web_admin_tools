      ...
      <div class="box1" style="text-align:center;"> 
       <input type="hidden" value="<?php echo $_POST['che1'];?>" id="che" name="che">
          <span class="info3" > 请输入要查询的域名：
            <font color="green"><b>HTTP://</b></font><input name="domain" type="text" id="domain" class="input" size="40" url="true" value="<?php echo $domain = $_POST['dom1']?$_POST['dom1']:'34ways.com';?>"/>
